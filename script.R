...
setwd("D:/Charla_visualizacion_con__perspectiva_de_genero/meetup-presentations_santafe/eventos/2019/01-Febrero")
programadoras <- read.csv(file = "programadorasnew.csv",header = TRUE)
## qué contienen
